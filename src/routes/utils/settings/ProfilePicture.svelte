...
<Card
	size="xl"
	class="block shadow-sm sm:flex sm:space-x-4 sm:py-6 xl:block xl:space-x-0 2xl:flex 2xl:space-x-4 p-4 sm:p-6"
	horizontal
>
	...
	<div class="py-0.5">
		...
		<p class="mb-4 mt-1 pt-px text-sm dark:text-gray-300">JPG, GIF or PNG. Max size of 800K</p>
