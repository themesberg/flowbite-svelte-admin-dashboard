...
<main class="relative h-full w-full overflow-y-auto bg-gray-50 p-4 dark:bg-gray-900">
	...
	<Table>
		<TableHead class="border-y border-gray-200 bg-gray-100 dark:border-gray-700">
			<TableHeadCell><Checkbox class="accent-primary-600"></Checkbox> class="accent-primary-600" /></TableHeadCell>
		...
		<TableBody>
			{#each Users as user}
				<TableBodyRow>
					<TableBodyCell><Checkbox class="accent-primary-600"> class="accent-primary-600" /></TableBodyCell>
